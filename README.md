# How to deploy a Plotly Dash app on Heroku

* You can view the finished app on heroku [here](https://flying-dog.herokuapp.com/).
...
#### Description
Dash is a Python framework for building analytical web applications. Dash ties modern UI elements like dropdowns, sliders, and graphs to your Python code. In this class, participants will learn how to build a simple Dash application and deploy it online.as follows:
```
